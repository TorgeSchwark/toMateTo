// Compiled WITHOUT vector-extension flags (plain -O2), so simd.hpp falls
// back to its scalar reference implementation. Also forces it explicitly.
#define NNUE_FORCE_SCALAR
